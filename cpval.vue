...
<div class="ui floating message cpval" id="cpval">
  ...
  <div class="cpval-container">
    <div class="cpval-content">
      ...
      <a class="ui label" @click="rows = rows.slice(0,1)" v-show="village!=='全区域'">清除</a>
      <a class="ui label" @click="show_all()" v-show="village!=='全区域'">List all</a>
      <table class="ui celled table unstackable">
        <thead>
          <tr>
            <th class="collapsing">贡献</th>
            <th class="collapsing">格数</th>
        ...
        <tbody>
          <tr v-for="(v,i) in rows" :key="i">
            ...
            <td>
              ...
              <template v-if="v.com > 1"><br>　　　（总共有 {{v.com}} 种房屋组合）</template>
            </td>
          </tr>
        </tbody>
      </table>
    </div>
    <div class="cpval-chart-control" v-show="village!=='全区域'">
